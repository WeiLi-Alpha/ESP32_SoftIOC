/*
This program enbales the control of the ESP32 board through serial communication, 
using commands in the format of 
<CMD0> <CMD1> <CMD2>,
For example:
AGET 12       // get ADC reading of GPIO_12
ASET 26 170  // get Voltage of GPIO_26 as 2.2 V (2.2/3.3*255)
...
In this firmware, the GPIO 
# 15,2,4,16,17,5,18,19,21 are set as OUTPUT
# 22,23 are set as INPUT
# 1,3 are left empty for serial communication.

-------------------------------------------
Ver. 1.0    Wei Li  11/30/2022  First version, which enables the DI, DO, AI and AO of corresponding pins 

-------------------------------------------
All the messages should be send in a way of "<CMD0> <CMD1> <CMD2>(optional)", separated by space.
...
// GPIO_1 and GPIO_3 are used for serial communication through UART port, shall not be used in this example.
//  pinMode(3, INPUT);
//  pinMode(1, INPUT);
  pinMode(22, INPUT);
  pinMode(23, INPUT);
