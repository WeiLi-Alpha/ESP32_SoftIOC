...
/* Generated from ../O.Common/ESP32_GPIO.dbd */
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_interpRegister, pvar_func_streamRegistrar,
...
int ESP32_GPIO_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/epics/baseAppl_devel/ESP32_GPIO";
...
/* ESP32_GPIO_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"ESP32_GPIO_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    ESP32_GPIO_registerRecordDeviceDriver(*iocshPpdbbase);
}
